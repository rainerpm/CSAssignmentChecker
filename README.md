...
* **Answer 1** in the Main Menu.  The program is now awaiting program submissions in the **/demo/1/** folder.
* To demo the more advanced verification of a JAVA program, copy the student program /demo/sampleSubmissions/studentProblems/Lovelace Ada 123456 - GCD.zip to the class period 1 folder /demo/1/.
