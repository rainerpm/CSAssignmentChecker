...
can be submitted directly to that folder in real time by the students (one way to do this is to have the students submit to an online folder that is automatically synched to the teacher's PC - e.g. [Dropbox File Request feature](https://fileinbox.com/articles/dropbox-file-requests-ultimate-guide#:~:text=Unfortunately%2C%20Dropbox%20File%20Requests%20don,to%20create%20a%20Dropbox%20account.) * [configForCSAC](https://docs.google.com/document/d/1eYExnGA379OsfLIX63w-FDVSutrMEuEhN8HCXWMP--Q/edit?usp=sharing) * [studentHowTo](https://docs.google.com/document/d/1kkS6wL0LpXrzCZg0AcApBOTlhE6sBPUwqzdSUEWnmH8/edit?usp=sharing)).
